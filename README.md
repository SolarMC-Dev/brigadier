...
This fork of brigadier contains code licensed under the MIT license from the original brigadier repository. This fork also contains code licensed under the GNU Lesser General Public License v3 or later, code which has been added to this fork.
